const About = () => {
    return (
        <div className="max-w-7xl mx-auto mt-3">
            ...
            <div className="grid lg:grid-cols-2 gap-8 mt-8 mb-10 mx-5">
                <div
                    className="border-4 lg:border-8 border-[#c9184a] lg:h-[580px] rounded lg:rounded-xl"
                    data-aos="fade-right"
                >
                    <img
                        src="https://i.ibb.co/XW1r2mB/about.jpg"
